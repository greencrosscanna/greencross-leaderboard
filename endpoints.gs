...
// ─────────────────────────────────────────────────────────────────────────────
//  Incentive thresholds — READ ONLY, for the kiosk discount color.
//  The incentive engine that used to live here (the payload, the per-seller
//  performance slice, the frozen closed periods and their routes) was retired
//  2026-09-14: GX Crew scores pay from GX Core's incentive_perf, and GX Core
//  holds the frozen-period archive. What stays is the discount target below.
// ─────────────────────────────────────────────────────────────────────────────
